...
class TestCreate(TestCase):
    ...
    def test_len(self):
        ...
        tlist = searchmse.create_img_list(root)
...
class TestSearch(TestCase):
    ...
    def test_dupes(self, threshold=500, root=r"tests\Dupe test"):
        ...
        for folder in testfolders:
            arr = searchmse.create_img_list(folder)
            if not arr:
                self.fail()
...
class TestSearch2(TestCase):
    ...
    def test_false(self):
        src = r"Dupe test/Checkers"
        dst = r"Dupe test/simple black"
        srclist = searchmse.create_img_list(src)
        dstlist = searchmse.create_img_list(dst)
    ...
    def test_dupe_test(self):
        src = r"Two folders/src"
        dst = r"Two folders/dst"
...
class TestImportExport(TestCase):
    ...
    def test_export_tensors(self, path=r"Test_images\Dupe test"):
        tlist = searchmse.create_img_list(path)
    ...
    def test_import_tensors2(self, path=r"Test_images\dupe test 3\test 2"):
        tlist = searchmse.create_img_list(path)
...
class TestFasterSearch(TestCase):
    ...
    def test_dupe_mixed(self, threshold=500, root=r"tests\dupe test 3"):
        ...
        # Each folder has two pairs of duplicate images
        for folder in testfolders:
            arr = fastermse.create_img_list(folder)
